-- ============================================================
-- All Migrations (Idempotent) — auto-run on server startup.
...
CREATE INDEX IF NOT EXISTS idx_events_server_time ON events(server_time);
...
CREATE INDEX IF NOT EXISTS idx_stimuli_session ON stimuli(session_id);
CREATE UNIQUE INDEX IF NOT EXISTS idx_stimuli_session_seq ON stimuli(session_id, sequence_nr);
